package com.huangyingsheng.web.commom.util;
...
public class DateUtils {
    ...
    public static int daysBetween(String startDate, String endDate, String format) throws Exception {
        return daysBetween(stringToDate(startDate, format), stringToDate(endDate, format));
    }
